        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <View style={styles.placeholderCard}>
                    ...
                    <Text style={styles.placeholderTitle}>Project Management Coming Soon</Text>
                    <Text style={styles.placeholderSub}>
                        You will be able to manage your 3D architectural projects, upload GLB models, and track VR sessions from here.
                    </Text>
                </View>
            </ScrollView>
            ...
            <View style={styles.bottomNav}>
                ...
                <NavItem label="Projects" icon="projects" active onPress={() => { }} />
                <NavItem label="AI" icon="chat" onPress={() => router.replace('/ai-assistant')} />
                <NavItem label="Clients" icon="users" onPress={() => router.replace('/clients')} />
            </View>
        </SafeAreaView>
    );
}
